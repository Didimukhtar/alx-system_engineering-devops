...
I encountered the issue upon opening the project and proceeded to solving the problem.
...
In short, a typographical error . Gotta love'em. In full, the WordPress app was encountering a critical
